...
export default function RegisterNoContractPage() {
  return (
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-6 px-6">
          <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-green-900 dark:text-green-100 text-sm">Completabile in circa 10 minuti</p>
              <p className="text-sm text-green-800 dark:text-green-200 mt-0.5">
                La procedura è completamente guidata: registrazione e configurazione dei pagamenti. Tieni a portata di mano le coordinate bancarie (IBAN).
              </p>
            </div>
          </div>
        </div>

        <BasicOnboardingForm skipContract={true} />
      </div>
    </div>
  );
}